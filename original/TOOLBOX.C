/***
*  TOOLBOX.C
*  Funáîes relacionadas com a toolbox.
*/


/***
*  option_box( BYTE nColor )
*  Exibe uma caixa em volta da opáÑo actualmente seleccionada. Esta opáÑo Ç
*  fornacida pela vari†vel p£blica nToolboxOp. A funáÑo recebe ainda um
*  parÉmetero que Ç a cor da caixa a ser exibida.
*/
...
*  Processa a toolbox, isto Ç, verifica qual o icon que foi seleccionado com
*  o rato e em seguida actualiza a vari†vel p£blica nToolboxOp.
*/
