/***
*  SAVE.C
*  Rotinas para salvar os comandos executados na mem¢ria e no disco.
*/


/***
*  save_command( void )
*  Salva o comando executado para a lista de comandos em mem¢ria.
*/
void save_command( void )
{
   if( ptrFirst == NULL )                             // Se a lista est  vazia
   {
      ptrFirst = ( LIST * )malloc( sizeof( LIST ) );   // Aloca p/ 1§ elemento
   ...
   else                   // Sen„o, ent„o a lista j  tem pelo menos 1 elemento
   {
      LIST *new_element;
...
/***
*  save( void )
*  Salva lista de comandos em mem¢ria para o ficheiro "JORGE.PNT".
*/
void save( void )
{
   if( ptrFirst != NULL )                         // Se a lista n„o est  vazia
   {
      int n, filehandle;
